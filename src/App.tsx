    ...
    <Container>
      ...
      {Object.keys(chord).length !== 0 ? (
          <>
            ...
            <Strings fret={chord.strings[0]} string="43px">{formatFingering(chord, 0)}</Strings>
            <Strings fret={chord.strings[1]} string="71px">{formatFingering(chord, 1)}</Strings>
            <Strings fret={chord.strings[2]} string="98px">{formatFingering(chord, 2)}</Strings>
            <Strings fret={chord.strings[3]} string="125px">{formatFingering(chord, 3)}</Strings>
            <Strings fret={chord.strings[4]} string="153px">{formatFingering(chord, 4)}</Strings>
            <Strings fret={chord.strings[5]} string="181px">{formatFingering(chord, 5)}</Strings>
            </Chords>
